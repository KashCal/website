---
title: "Share an event as a card on Android"
...
# Share an event the way you'd want to
...
**Standard** for the things on your week. **Celebration** for birthdays, weddings, and the rest. Both go out in one tap.
...
<Cards items={[
  ...
  {title: 'Multi-day events', body: <>A horizontal range chip ("MAY 31 – JUN 03"), with day-of-week in the body so the chip stays light.</>},
