...
image: /img/social/accessible-calendar-android.png
---
...
Text and background colors are checked for readability by tests that run on every build, and the main screens are put through Google's accessibility checks, the same engine behind Accessibility Scanner, on a real device before a release. It's a standing part of how the app is tested, not a one-time pass.
