...
const SAMPLE: (Day | null)[] = [
  ...
  {n: 2},
  {n: 3, note: 'Small win: you opened the calendar instead of the news.', kind: 'Gentle'},
  {n: 4},
  {n: 5},
  {n: 6, note: '"Gym" has recurred since March. The RRULE is the consistent one.', kind: 'Calendar joke'},
  {n: 7},
  {n: 8},
  {n: 9, note: "You've got this. Statistically, someone has to.", kind: 'Snark'},
  {n: 10},
  {n: 11},
  {n: 12, note: 'Drink water. Coffee is an argument, not water.', kind: 'Gentle ribbing'},
  {n: 13},
  {n: 14},
  ...
  {n: 19},
  {n: 20},
  {n: 21, note: 'Nothing scheduled today. That was, in fact, the plan.', kind: 'Snark'},
  {n: 22},
  {n: 23, cta: true},
  {n: 24},
  {n: 25, note: 'Be kind to yourself. You are doing better than this implies.', kind: 'Sincere, briefly'},
  {n: 26},
  {n: 27},
  {n: 28, note: 'This note has no location. Neither do your goals. Kidding. Mostly.', kind: 'Snark'},
  {n: 29},
  {n: 30},
  {n: 31, note: 'Made it to the end of the month. Low bar. Cleared it anyway. Proud of you.', kind: 'Sincere'},
  null,
];
