...
"When are you free?" usually costs you a few minutes of squinting at your own
calendar and typing out times. KashCal does the squinting. Pick how far ahead to
look and what counts as your working hours, and it writes out your free blocks as
plain text you can paste into any chat.
...
- **Window:** how many days ahead to look, from 1 to 14. The default is 7. Below the
  slider, **Through &lt;date&gt;** spells out the last day you've included, so you don't
  have to count.
- **Working hours:** the span of each day to consider, shown as a strip of the whole
  24 hours with your window highlighted and the rest dimmed. Drag either end. The
  default is 9:00 to 17:00, and the caption reads out the length ("8 hour window").
  The window can't be shorter than an hour.

There's also **All-day events as busy**. Off by default, so a birthday or an
...
- Today is trimmed to now, so you never offer a time that has already passed. If the
  rest of today is already outside your working hours, today drops out.
...
If nothing qualifies, KashCal says so rather than sending an empty message:
